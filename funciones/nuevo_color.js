...
$(document).ready(function() {
	...
	$("#btn_aceptar").click(function(){
		...
		var descripcion = $("#desc_color").val();
	
		// Validación del campo descripcion
		if( descripcion == "" ){
			$("#dialog-success").html("<span>Por favor ingrese un color</span>");
...
//###############################################################################################################################//
	...
	// Validación de color repetido
	if (valor == 2)
	{
			$("#dialog-success").html("<span>El color ingresado ya existe!</span>");
				$("#dialog-success").dialog({
					autoOpen: false,
					resizable: false,
					height: "auto",
	...
	if (valor == 1)
	{
			$("#dialog-success").html("<span>Color insertado exitosamente!</span>");
				$("#dialog-success").dialog({
					autoOpen: false,
					resizable: false,
					height: "auto",
