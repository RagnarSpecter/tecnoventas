...
$(document).ready(function() {
	...
	$("#btn_aceptar").click(function(){
		...
		if( descripcion == "" ){
			$("#dialog-success").html("<span>Por favor ingrese una marca</span>");
...
//###############################################################################################################################//
	...
	// Validación de marca repetida
	if (valor == 2)
	{
			$("#dialog-success").html("<span>La marca ingresada ya existe!</span>");
				$("#dialog-success").dialog({
					autoOpen: false,
					resizable: false,
					height: "auto",
	...
	if (valor == 1)
	{
			$("#dialog-success").html("<span>Marca insertada exitosamente!</span>");
				$("#dialog-success").dialog({
					autoOpen: false,
					resizable: false,
					height: "auto",
