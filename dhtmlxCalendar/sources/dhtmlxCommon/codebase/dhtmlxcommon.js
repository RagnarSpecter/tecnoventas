...
if (typeof(window.dhx4.dateLang) == "undefined") {
	...
	window.dhx4.dateStrings = {
		en: {
			monthFullName:	["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"],
			monthShortName:	["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Set","Oct","Nov","Dic"],
			dayFullName:	["Doming","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado"],
			dayShortName:	["Do","Lu","Ma","Mi","Ju","Vi","Sa"]
		}
	};
